...
public class OrderFactory {
    ...
    private static final String[] MENU_ITEMS = {"cooked_hotdog", "cooked_quekquek", "cooked_tempura", "mango_ready", "calamansiJuice_finishedProduct","bukoJuice_finishedProduct","orangeJuice_finishedProduct"};
