...
public class Calamansi_Juice extends StoreItem {
    public Calamansi_Juice(String container, String rawResource, String cookedResource, String description, Double preparationTime, Double sellingPrice, Double discardCost, int status, int height, int width) {
