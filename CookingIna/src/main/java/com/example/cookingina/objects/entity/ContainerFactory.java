...
public class ContainerFactory {
    ...
    public static Container create(TYPE type) {
        switch (type) {
            ...
            case TEMPURA:
                return new Container (new StoreItem("tempura","rawQuekquek_container.png", "rawQuekquek.png", false,15.0,12.99, 2.0, 1 ,80, 80), "rawTempura_container.png");
            case CUCUMBER:
            ...
            case MANGO:
                return new Container (new StoreItem("mango","rawQuekquek_container.png", "rawQuekquek.png", false,15.0,12.99, 2.0, 1 ,80, 80) , "mango_container.png");
            case BAGOONG:
