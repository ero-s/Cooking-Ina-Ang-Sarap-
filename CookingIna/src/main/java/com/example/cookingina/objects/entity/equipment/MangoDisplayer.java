...
public class MangoDisplayer extends Equipment {
    private boolean isOccupied = false; // New field
    public boolean isUnlocked = true;
    public MangoDisplayer(String emptyResource, String usedResource, int type, int playend, double speedMultiplier,
